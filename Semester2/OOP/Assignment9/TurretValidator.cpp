...
void TurretValidator::validateTurret(const NorvenTurret &turretToValidate) {
    ...
    if(turretToValidate.getLocationOfTurret().size() < 3)
        errorMessage += std::string("The location of a turret cannot be less than 3 characters!\n");
    if(turretToValidate.getSizeOfTurret().size() < 3)
        errorMessage += std::string("The size of a turret cannot be less than 3 characters!\n");
    ...
    if(turretToValidate.getVisionOfTurret().size() < 3)
        errorMessage += std::string("The vision of a turret cannot be less than 3 characters!\n");
