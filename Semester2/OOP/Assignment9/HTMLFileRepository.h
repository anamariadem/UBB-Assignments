...
#ifndef ASSIGNMENT8_REMASTERED_HTMLFILEREPOSITORY_H
#define ASSIGNMENT8_REMASTERED_HTMLFILEREPOSITORY_H
...
public:
    ...
    HTMLFileRepository(){this->fileName = ""; };
...
#endif //ASSIGNMENT8_REMASTERED_HTMLFILEREPOSITORY_H
