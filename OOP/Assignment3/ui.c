...
void start(UserInterface* ui){
    ...
    while(stillRunning == 0){
        ...
        else if (strcmp(command, "listtype\n") == 0)
            listTheTypesOfExistingGears(ui);
        else if (strcmp(command, "liststate\n") == 0)
            listTheStatesOfExistingGears(ui);
        else if (strcmp(command, "listvalue\n") == 0)
            listTheValuesOfExistingGears(ui);
        else
